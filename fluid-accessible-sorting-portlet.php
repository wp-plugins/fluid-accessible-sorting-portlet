...
function FluidAccessibleSortingPortlet_init() {
    ...
    if ( !is_admin() && is_active_widget('widget_FluidAccessibleSortingPortlet') ) {
        wp_register_script('InfusionAll', ( get_bloginfo('wpurl') . '/wp-content/plugins/fluid-accessible-sorting-portlet/lib/InfusionAll.js'));
        wp_enqueue_script('InfusionAll');

        wp_register_script('FluidAccessibleSortingPortlet', ( get_bloginfo('wpurl') . '/wp-content/plugins/fluid-accessible-sorting-portlet/lib/FluidAccessibleSortingPortlet.js'));
